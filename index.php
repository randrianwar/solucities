...
<div class="body">
    ...
    <div class="site-header-wrapper">
        ...
        <header class="site-header">
            <div class="container">
                <div class="site-logo">
                    <a class="<?php if (!isset($_GET['page'])) { echo 'active'; } ?>"><a href="./" class="default-logo"><img src="images/logo.png" alt="Logo"></a>
                    <a class="<?php if (!isset($_GET['page'])) { echo 'active'; } ?>"><a href="./" class="default-retina-logo"><img src="images/logo%402x.png" alt="Logo" width="199" height="30"></a>
                    <a class="<?php if (!isset($_GET['page'])) { echo 'active'; } ?>"><a href="./" class="sticky-logo"><img src="images/sticky-logo.png" alt="Logo"></a>
                    <a class="<?php if (!isset($_GET['page'])) { echo 'active'; } ?>"><a href="./" class="sticky-retina-logo"><img src="images/sticky-logo%402x.png" alt="Logo" width="199" height="30"></a>
                </div>
                ...
                <ul class="sf-menu dd-menu pull-right" role="menu">
                    ...
                    <li><a href="">About</a>
                    	<ul>
                    		<li class="<?php if ($_GET['page']=='intro') { echo 'active'; } ?>"><a href="./?page=intro">Introduction</a></li>
                    		<li class="<?php if ($_GET['page']=='team') { echo 'active'; } ?>"><a href="./?page=team">Team</a></li>
        	...
        	<div class="row">
            	<div class="col-md-4 col-sm-4">
                	<div class="widget footer_widget">
                        ...
                        <p>Adalah sebuah crowdfunding / penggalangan dana online dan media kolaborasi masyarakat urban (komunitas) untuk terlibat memberi solusi nyata pada kota-kota di Indonesia. Baik berupa ide / solusi yang bisa diwujudkan ataupun dalam bentuk pendanaan.</p>
                        <p>Solucities.com fokus pada permasalahan urban sprawl / permukiman kumuh, infrastruktur skala urban dan upaya meningkatkan indeks kebahagiaan masyarakat urban. </p>
                    </div>
                </div>
            	<div class="col-md-4 col-sm-4">
        		...
        		<div class="row">
                    <div class="col-md-6 col-sm-6 donate-amount-option">
                        ...
                        <ul class="predefined-amount">
                            <li><label><input type="radio" name="donation-amount">10rb</label></li>
                            <li><label><input type="radio" name="donation-amount">20rb</label></li>
                            <li><label><input type="radio" name="donation-amount">30rb</label></li>
                            <li><label><input type="radio" name="donation-amount">50rb</label></li>
                            <li><label><input type="radio" name="donation-amount">100rb</label></li>
                        </ul>
                    </div>
