<div class="row">
  <div class="col-lg-12">
    <h3 class="page-header"><i class="fa fa-files-o"></i> Edit User Form</h3>
    <ol class="breadcrumb">
                    ...
                    <?php
                      if (isset($_POST['input'])) {
                        ...
                        $pass = md5($pass);
                            ...
                            $sql = "UPDATE users SET nip='$nip', name='$name', email='$email', study='$study', gender='$gender', notlp='$notlp', user='$user', pass='$pass' WHERE id=".$_GET['id'];
						                $result = $conn->query($sql);
