...
<html lang="en">
  ...
  <section id="container">
      <header class="header dark-bg">
            <!--logo start-->
            <a href="#" class="logo"><span class="lite">Portal Users</span></a>
            <!--logo end-->
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li class="eborder-top" class="<?php if ($_GET['page']=='pr') { echo "active"; } ?>"><a href="user.php?page=pr"><i class="icon_profile"></i> My Profile</a>
                            </li>
                            <li>
