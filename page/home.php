...
<div class="hero-area">
  <!-- Start Hero Slider -->
    <div class="flexslider heroflex hero-slider" data-autoplay="yes" data-pagination="no" data-arrows="yes" data-style="fade" data-pause="yes">
        <ul class="slides">
            <li class="parallax" style="background-image:url(images/slide4.jpg)">
                      ...
                      <div class="flex-caption-table">
                          <div class="flex-caption-cell">
                              <div class="flex-caption-text">
                                    ...
                                    <a href="causes.html" class="btn btn-success">Start with a little</a>
                                </div>
                            </div>
                        </div>
                    </div>
                      ...
                      <div class="flex-caption-table">
                          <div class="flex-caption-cell">
                              <div class="flex-caption-text text-align-center">
                                    <h2>“Let’s Collaborate to Make Solution for Ours Cities”</h2>
                                    <a href="causes.html" class="btn btn-success btn-lg">Start with a little</a>
                                </div>
                            </div>
                        </div>
                    </div>
                  ...
                  <div class="container">
                      <div class="flex-caption-table">
                          ...
                          <p>Lorem ipsum dolor sit amet, consectet adipiscing elit. Nam malesuada dapi bus diam, ut fringilla purus efficitur  eget.</p>
                                      <span class="meta-data">Donated Rp.2.640.000 / <span class="cause-target">Rp3.000.000</span></span>
                                    <a href="#" class="btn btn-success btn-lg" data-toggle="modal" data-target="#DonateModal">Donate Now</a>
                            </div>
                        </div>
                    </div>
                    </div>
...
<div class="featured-links row">
  <a href="./?page=event" class="featured-link col-md-6 col-sm-6">
      <span>View our causes</span>
      <strong>Donate now</strong>
    </a>
  <a href="./?page=register" class="featured-link col-md-6 col-sm-6">
          ...
          <div class="container">
                <div class="featured-texts row">
                  <div class="featured-text col-md-4 col-sm-4">
                      <span>Successful Solution</span>
                        <strong>1043</strong>
                    </div>
                  <div class="featured-text col-md-4 col-sm-4">
                      <span>Total Founding</span>
                        <strong>Rp.78.500.980</strong>
                    </div>
                  <div class="featured-text col-md-4 col-sm-4">
                    ...
                    <div class="row">
                      <div class="container">
                        <div class="text-align-center">
                              <h2 class="block-title block-title-center">Solution</h2>
                          </div>
                      </div>
                          ...
                          <li class="item">
                              <div class="grid-item cause-grid-item small-business format-standard">
                                  <div class="grid-item-inner">
                                      <a href="./?page=em" class="media-box">
                                      ...
                                      <div class="grid-item-content">
                                          ...
                                          <div class="meta-data">Donated Rp. 1.760.000 / <span class="cause-target">Rp. 2.000.000</span></div>
                                      </div>
                                ...
                                <div class="grid-item cause-grid-item small-business format-standard">
                                    <div class="grid-item-inner">
                                        ...
                                        <div class="grid-item-content">
                                            ...
                                            <div class="meta-data">Donated Rp.264.000 / <span class="cause-target">Rp. 300.000</span></div>
                                        </div>
                                      <a href="#" class="btn btn-success" data-toggle="modal" data-target="#DonateModal">Donate Now</a>
                                    </div>
                                </div>
                                ...
                                <div class="grid-item cause-grid-item small-business format-standard">
                                    <div class="grid-item-inner">
                                        ...
                                        <div class="grid-item-content">
                                            ...
                                            <div class="meta-data">Donated Rp. 2.184.000 / <span class="cause-target">Rp. 4.000.000</span></div>
                                        </div>
                                      <a href="#" class="btn btn-success" data-toggle="modal" data-target="#DonateModal">Donate Now</a>
                                    </div>
                                </div>
                                ...
                                <div class="grid-item cause-grid-item small-business format-standard">
                                    <div class="grid-item-inner">
                                        ...
                                        <div class="grid-item-content">
                                            ...
                                            <div class="meta-data">Donated Rp. 1.500.000 / <span class="cause-target">Rp. 2.000.000</span></div>
                                        </div>
                                      <a href="#" class="btn btn-success" data-toggle="modal" data-target="#DonateModal">Donate Now</a>
                                    </div>
                                </div>
                                ...
                                <div class="grid-item cause-grid-item small-business format-standard">
                                    <div class="grid-item-inner">
                                        ...
                                        <div class="grid-item-content">
                                            ...
                                            <div class="meta-data">Donated Rp. 400.000 / <span class="cause-target">Rp. 2.000.000</span></div>
                                        </div>
                                      <a href="#" class="btn btn-success" data-toggle="modal" data-target="#DonateModal">Donate Now</a>
                                    </div>
                                </div>
                                ...
                                <div class="grid-item cause-grid-item small-business format-standard">
                                    <div class="grid-item-inner">
                                        ...
                                        <div class="grid-item-content">
                                            ...
                                            <div class="meta-data">Donated Rp.500.000 / <span class="cause-target">Rp. 1.000.000</span></div>
                                        </div>
                                      <a href="#" class="btn btn-success" data-toggle="modal" data-target="#DonateModal">Donate Now</a>
                                    </div>
                                </div>
              ...
              <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="carousel-wrapper">
                          <div class="container">
                            <div class="text-align-center">
                                  <h2 class="block-title block-title-center">Problems</h2>
                              </div>
                          </div>
                            <div class="row">
                                <ul class="owl-carousel carousel-fw" id="news-slider" data-columns="3" data-autoplay="" data-pagination="yes" data-arrows="no" data-single-item="no" data-items-desktop="2" data-items-desktop-small="1" data-items-tablet="1" data-items-mobile="1">
                                    <li class="item">
                                        <div class="grid-item blog-grid-item format-standard">
                                            <div class="grid-item-inner">
                                                <a href="./?page=nr" class="media-box">
                                                    <img src="images/post1.jpg" alt="">
                                                </a>
                                                <div class="grid-item-content">
